...
public class BulletNlo : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        NloBullPool = GameObject.FindGameObjectWithTag("NloBulletPool");
    ...
    void FixedUpdate()
    {
        ...
        if(timer >= lifeTime)
        {
            ...
            _rb.inertia = 0;
            gameObject.transform.parent = NloBullPool.transform;
      ...
      //       _rb.inertia = 0;
      //       gameObject.transform.parent = NloBullPool.transform;
      //      gameObject.SetActive(false); // Пуля уничтожается
      //     }
      //  }
